...
class PrimaveraQuente : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_primavera_quente)
        ...
        refazer.setOnClickListener {
            val intent = Intent(this@PrimaveraQuente, MainActivity::class.java)
            startActivity(intent)
        }
    }
}